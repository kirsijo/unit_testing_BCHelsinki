    ...
    expect(storage.getAllBooksByAuthor("Felix Harris")).toEqual([
      {
        ...
        price: 200,
        amount: 5,
        genres: ["fiction", "chronic", "short story"],
      },
    ]);
  });
  ...
  test("test 2: get all books by Layla Jones", () => {
    ...
    const testData = [
      ...
      },
      {
        ...
        price: 123,
        amount: 1,
        genres: ["humorous essay", "nonfiction", "fiction"],
        info: {
          notes: "-",
          booktype: "leaflet",
      ...
      },
      {
        ...
        price: 123,
        amount: 13,
        genres: ["nonfiction", "short story", "chronic"],
        info: {
          notes: "collectors edition",
          booktype: "softcover",
...
describe("Testing getBookGenres", () => {
  test("test 1: get all books by authorNumber 3", () => {
    const storage = new BookStorage(books);
    const expectedResult = ["nonfiction", "short story", "chronic"];
...
describe("Testing getTotalPriceOfBooksByAuthor", () => {
  ...
  test("Test 3: No books found with given search value", () => {
    expect(storage.getTotalPriceOfBooksByAuthor("Kirsi Jokela")).toEqual(
      "nothing found with given"
    );
  });
  test("Test 4: missing parameter throws an error", () => {
    expect(() => storage.getTotalPriceOfBooksByAuthor()).toThrow(
      "missing parameter"
    );
  });
